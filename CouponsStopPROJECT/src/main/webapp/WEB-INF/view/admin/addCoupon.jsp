        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
              <f:form action="insertCoupon" method="post" modelAttribute="coupondata" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <label for="input-6" class="col-sm-2 col-form-label">Company Name</label>
                  <div class="col-sm-10">
                  <f:select path="CompanyVO.companyId">
                  <f:options items="${companyList }" itemLabel="companyName" itemValue="companyId"/>
                  </f:select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <f:input path="couponName" class="form-control" required="required" />
                  </div>
                </div>
                
                
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">Coupon Code</label>
                  <div class="col-sm-10">
                  <f:input path="couponCode" class="form-control" required="required" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Coupon Discount</label>
                  <div class="col-sm-10">
                  <f:input path="couponDiscount" class="form-control" required="required" />
                    
                  </div>
                </div>

				<div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Coupon Price</label>
                  <div class="col-sm-10">
                  <f:input path="couponPrice" class="form-control" required="required" />
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <f:textarea path="couponDescription" class="form-control" required="required"/>
