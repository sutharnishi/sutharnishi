            ...
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <tbody>
	               ...
	               <c:forEach items="${categoryList}" var="i"  varStatus="x">
	               	<tr>
	               		<td>${x.count}</td>
 						<td>${i.categoryName}</td>
 						<td>${i.categoryDescription}</td>
 						<td><a href="editCategory?categoryId=${i.categoryId}">Edit</a>
						<a href="deleteCategory?categoryId=${i.categoryId}">Delete</a></td>
					</tr>	  
	               </c:forEach>
