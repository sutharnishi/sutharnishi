        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
              ...
              <f:form  action="insertReply" method="post" modelAttribute="complaintVO">
                ...
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">Complaint Subject</label>
                  <div class="col-sm-10">
                   <f:input type="text" path="complaintSubject" class="form-control" readonly="readonly"/>       
                  </div>
                </div>
                
               
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Complaint Description</label>
                  <div class="col-sm-10">
                  <f:input type="text" path="complaintDescription" class="form-control" readonly="readonly"/>  
                  </div>
                </div>
                
                
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Reply</label>
                  <div class="col-sm-10">
