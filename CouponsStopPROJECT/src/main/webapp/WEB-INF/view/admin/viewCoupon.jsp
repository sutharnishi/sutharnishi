          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <tbody>
                	<c:forEach items="${couponlist}" var="i" varStatus="x">
                	<tr>
                		...
                		<td>${i.couponName }</td>
                		<td>${i.couponCode }</td>
                		<td>${i.couponDiscount }</td>
                		<td>${i.couponPrice }</td>
                		<td>${i.couponDescription }</td>
                		<td><a href="<%=request.getContextPath()%>/documents/coupons/${i.fileName}">View</a></td>
                		<td><a href="editCoupon?couponId=${i.couponId}">Edit</a>
                		<a href="deleteCoupon?couponId=${i.couponId }">Delete</a></td>
                	</tr>
                	</c:forEach>
                	</tbody>
              </table>
