  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Complain page</h4>
		    <ol class="breadcrumb">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="personal-info" action="viewcomplain.jsp" >
                ...
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">Contact No.</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-1" name="contact" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Complain</label>
                  <div class="col-sm-10">
                    <textarea rows="5" cols="5" class="form-control" id="input-2" name="complain" required></textarea>
                  </div>
                </div>
