        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
              <f:form action="insertCity" method="post" modelAttribute="cityData">
                ...
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">City Name</label>
                  <div class="col-sm-10">
                  <f:input path="cityName" class="form-control" required="required" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <f:textarea path="cityDescription" class="form-control" required="required"/>
                  </div>
                </div>
