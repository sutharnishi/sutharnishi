          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <tbody>
                <c:forEach items="${packagelist}" var="i" varStatus="x" >
                <tr>
                        <td>${x.count}</td>
 						<td>${i.packageName}</td>
 						<td>${i.packagePrice}</td>
 						<td>${i.numberofCoupons}</td>
 						<td>${i.packageDescription}</td>
 						<td><a href="<%=request.getContextPath()%>/documents/packages/${i.fileName}">View</a></td> 
 						<td><a href="editPackage?packageId=${i.packageId}">Edit</a>
						<a href="deletePackage?packageId=${i.packageId}">Delete</a></td>	 
                </tr>
                </c:forEach>
                </tbody>
              </table>
