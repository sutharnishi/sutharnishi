        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
              <f:form action="insertCompany" method="post" modelAttribute="companydata" enctype="multipart/form-data" >
                ...
                <div class="form-group row">
                  <label for="input-6" class="col-sm-2 col-form-label">Category Name</label>
                  <div class="col-sm-10">
                  <f:select path="CategoryVO.categoryId">
                ...
                <div class="form-group row">
                  <label for="input-6" class="col-sm-2 col-form-label">SubCategory Name</label>
                  <div class="col-sm-10">
                  <f:select path="SubcategoryVO.subcategoryId">
                  <f:options items="${subcategoryList }" itemLabel="subcategoryName" itemValue="subcategoryId"/>
                  </f:select>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <f:input path="companyName" class="form-control" required="required" />
                  </div>
                </div>
                
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">Email-Id</label>
                  <div class="col-sm-10">
                  <f:input path="companyEmailId" class="form-control" required="required" />
                  </div>
                </div>
                
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Contact</label>
                  <div class="col-sm-10">
                  <f:input path="companyContact" class="form-control" required="required" />
                  </div> 
                </div>
                
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">website</label>
                  <div class="col-sm-10">
                  <f:input path="companyWebsite" class="form-control" required="required" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <f:textarea path="companyAddress" class="form-control" required="required"/>
              	  </div>      
                </div>
                  
                <div class="form-group row">
                  <label for="input-6" class="col-sm-2 col-form-label">City</label>
                  <div class="col-sm-10">
                  <f:select path="CityVO.cityid">
                ...
                <div class="form-group row">
                  <label for="input-6" class="col-sm-2 col-form-label">Area</label>
                  <div class="col-sm-10">
                  <f:select path="AreaVO.areaId">
                ...
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Description</label>
                  <div class="col-sm-10">
                  <f:textarea path="companyDescription" class="form-control" required="required"/>
                  </div> 
                </div>
                
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">photo</label>
                  <div class="col-sm-10">
