            ...
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <tr>
                        ...
                        <td><a href="<%=request.getContextPath()%>/documents/demo/${i.fileName}">View</a></td>
                        <td><a href="editCompany?companyId=${i.companyId}">Edit</a>
						<a href="deleteCompany?companyId=${i.companyId}">Delete</a></td>
                 </tr>
                 </c:forEach>    
                </tbody>
                 </table>
