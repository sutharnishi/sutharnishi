  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">LOGIN FORM</h4>
		    <ol class="breadcrumb">
            ...
            <div class="card-body">
              <form id="personal-info">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="input-2" name="lname" required>
                  </div>
                </div>
        		...
        		<div class="form-footer">
                    <button type="submit" class="btn btn-success"><i class="fa fa-check-square-o"></i>LOGIN</button>
                    <button type="submit" class="btn btn-success"><i class="fa fa-check-square-o"></i>REGISTER</button></br></br>
                    <button type="submit" class="btn btn-success"><i class="fa fa-check-square-o"></i>COMPANY REGISTER</button>
                    <button type="submit" class="btn btn-success"><i class="fa fa-check-square-o"></i>USER REGISTER</button>
              	</div>
              </form>
            </div>
          </div>
