          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <tbody>
                	<c:forEach items="${subcategoryList}" var="i" varStatus="x">
                <tr>
                        <td>${x.count}</td>
                        <td>${i.categoryVO.categoryName}</td>
 						<td>${i.subcategoryName}</td>
 						<td>${i.subcategoryDescription}</td> 
 						<td><a href="editSubcategory?subcategoryId=${i.subcategoryId}">Edit</a>
						<a href="deleteSubcategory?subcategoryId=${i.subcategoryId}">Delete</a></td>	 
                </tr>
                </c:forEach>
                </tbody>
              </table>
