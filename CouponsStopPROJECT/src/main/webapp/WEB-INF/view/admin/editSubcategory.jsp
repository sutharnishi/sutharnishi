  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">manage Subcategoroy</h4>
		    <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
              <f:form action="updateSubcategory" method="post" modelAttribute="subcategorylist">
                ...
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">SubCategory Name</label>
                  <div class="col-sm-10">
                  <f:input path="subcategoryName" class="form-control" required="required" />
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <f:input path="subcategoryDescription" class="form-control" required="required" />
                  </div>
                </div>
