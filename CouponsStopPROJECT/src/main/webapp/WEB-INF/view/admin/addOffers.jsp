    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="insertOffer" method="get">
                <h4 class="form-header text-uppercase">
                  <i class="fa fa-user-circle-o"></i>
                   Personal Info
                </h4>
                <div class="form-group row">
                  <label for="input-6" class="col-sm-2 col-form-label">Comapany Name</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">Offers</label>
                  <div class="col-sm-10">
