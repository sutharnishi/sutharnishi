                    ...
                    <div class="row row-rl-10 row-tb-20">
                        <div class="page-content col-xs-12 col-sm-8 col-md-9">
                            ...
                            <section class="section checkout-area panel prl-30 pt-20 pb-40">
                                <h2 class="h2 mb-20 h-title">Complain Form</h2>
                                <%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                                
                                
                                
                                <f:form class="mb-30" action="insertComplaint" modelAttribute="ComplaintVO" method="post">
                                   
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Complain Subject</label>
                                                <f:input type="text" path="complaintSubject" class="form-control" placeholder="Enter title"/>
                                            </div>
                                        </div>
                                    </div>
...
\                                            <div class="form-group">
                                              ...
                                              <f:textarea path="complaintDescription" class="form-control" />
                                            </div>
                                        </div>
                                    </div>

									<button class="btn btn-lg btn-rounded mr-10">Submit</button>
    ...
    function validate()
     {
         ...
         if( document.myForm.complaintSubject.value == "" ) 
         {
            alert( "Please provide Subject!" );
            document.myForm.complaintSubject.focus() ;
            return false;
         }
         if( document.myForm.complaintDescription.value == "" ) {
             alert( "Please provide complaintDescription!" );
             document.myForm.complaintDescription.focus() ;
             return false;
          }
     } -->
