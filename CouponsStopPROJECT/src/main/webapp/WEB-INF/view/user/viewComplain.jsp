...
<link rel="apple-touch-icon"
	href="<%=request.getContextPath()%>/userResources/images/apple-touch-icon.png">
...
<!-- Linearicons -->
<link
	href="<%=request.getContextPath()%>/userResources/css/linearicons.css"
	rel="stylesheet">
...
<link
	...
	rel="stylesheet">
<link
	href="<%=request.getContextPath()%>/userResources/css/owl.theme.min.css"
	rel="stylesheet">

<!-- Flex Slider -->
<link
	href="<%=request.getContextPath()%>/userResources/css/flexslider.css"
	rel="stylesheet">

<!-- Template Stylesheet -->
<link href="<%=request.getContextPath()%>/userResources/css/base.css"
	rel="stylesheet">
...
<body id="body" class="wide-layout preloader-active">
					...
					<div class="row">
						<div class="col-sm-12 col-md-4 is-hidden-sm-down">
							<!-- <ul class="nav-top nav-top-left list-inline t-left">
								<li><a href="terms_conditions.html"><i
										class="fa fa-question-circle"></i>Discounts Guide</a></li>
								<li><a href="faq.html"><i class="fa fa-support"></i>Customer
										Assistance</a></li>
							</ul> -->
						</div>
						<div class="col-sm-12 col-md-8">
							<ul
								...
								<!-- <li><a href="#"><i class="fa fa-flag-en"></i>English <i
										class="fa fa-caret-down"></i></a>
									<ul>
										<li><a href="cart.html"><i class="fa fa-flag-en"></i>English</a>
										</li>
										<li><a href="./ar/cart.html"><i class="fa fa-flag-ar"></i>العربية</a>
										</li>
									</ul></li> -->
								<li>
						</li>
				...
				<div class="container">
					<div class="row row-rl-0 row-tb-20 row-md-cell">
						<div class="brand col-md-3 t-xs-center t-md-left valign-middle">
							<a href="#" class="logo"> <img src="<%=request.getContextPath()%>/userResources/images/logo1.png"
								alt="" width="250">
							</a>
						</div>
							...
							<div class="row row-tb-10 ">
								...
								<div class="col-sm-4 t-xs-center t-md-right">
									<div class="header-cart">
										<a href="cart.html"> <span class="icon lnr lnr-cart"></span>
											<div>
				...
				<div class="cart-area ptb-60">
					<div class="container">
						<div class="cart-wrapper">
							<h3 class="h-title mb-30 t-uppercase">view Complain</h3>
							<table id="cart_list" class="cart-list mb-30">
								...
								<tbody id="tblbody">
									...
									<c:forEach var="i" items="${complaintList}" varStatus="j">
                                            ...
                                            <td>
                                                <div class="media-left is-hidden-sm-down">
                                                    <figure class="product-thumb">
                                                        <img src="<%=request.getContextPath() %>/userResources/images/product_02.jpg" alt="product">
                                                    </figure>
                                                </div>
									...
									<%--   <tr class="panel alert">
                                            <td>
                                                <div class="media-left is-hidden-sm-down">
                                                    <figure class="product-thumb">
                                                        <img src="<%=request.getContextPath() %>/userResources/images/product_03.jpg" alt="product">
                                                    </figure>
                                                </div>
                                                <div class="media-body valign-middle">
                                                    <h6 class="title mb-15 t-uppercase"><a href="#">Diamond engagement ring</a></h6>
									...
									<%--   <tr class="panel alert">
                                            <td>
                                                <div class="media-left is-hidden-sm-down">
                                                    <figure class="product-thumb">
                                                        <img src="<%=request.getContextPath() %>/userResources/images/product_04.jpg" alt="product">
                                                    </figure>
                                                </div>
                                                <div class="media-body valign-middle">
                                                    <h6 class="title mb-15 t-uppercase"><a href="#">Diamond engagement ring</a></h6>
					...
					<!-- <form action="payment" method="get">
							<div class="cart-price">
								...
								<ul class="panel mb-20">
									...
									<li>
										...
										<h4><div class="price" id="grandtotal">
										</div></h4>
									</li>
								</ul>
							...
							<input type="text" id="sstotal" name="total"/>
							<button type="submit" class="btn btn-rounded btn-lg" value="grandtotal">CHECKOUT</a></button>
 ...
 -->							
	...
	href="https://google.com" class="buy-theme"
		data-href="https://themeforest.net/item/friday-coupons-deals-discounts-promo-codes-template/19577226?ref=CODASTROID"
		target="_blank" id="buy_theme"> <i class="fa fa-credit-card"></i>
	</a>
	...
	<script type="text/javascript">
		function fnsubtotal() {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				console.log("<<<<<<IN FORLOOP>>>>>>"+subtotal);
			}
			console.log("subtotal?>>>>>>"+subtotal);
			document.getElementById("grandtotal").innerHTML = subtotal;
			document.getElementById("sstotal").value = subtotal;
	...
	<!-- ––––––––––––––––––––––––––––––––––––––––– -->
	<script
		src="<%=request.getContextPath()%>/userResources/js/jquery-1.12.3.min.js"></script>
	...
	<!-- Modernizer JS -->
	<script
		src="<%=request.getContextPath()%>/userResources/js/modernizr-2.6.2.min.js"></script>
	...
	<!-- FlexSlider -->
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/userResources/js/jquery.flexslider-min.js"></script>
	...
	<!-- ––––––––––––––––––––––––––––––––––––––––– -->
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/userResources/js/main.js"></script>
