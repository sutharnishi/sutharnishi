                ...
                <div class="row row-tb-20">
                        ...
                        <div class="row row-tb-20">
                            <div class="footer-col col-sm-6">
                                <div class="footer-about">
                                    <img class="mb-40" src="<%=request.getContextPath() %>/userResources/images/logo1.png" width="250" alt="">
                                ...
                                <div class="footer-top-instagram instagram-widget">
                                    ...
                                    <div class="row row-tb-5 row-rl-5">
                                        ...
                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="<%=request.getContextPath() %>/userResources/images/instagram_01.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="<%=request.getContextPath() %>/userResources/images/instagram_02.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="<%=request.getContextPath() %>/userResources/images/instagram_03.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="<%=request.getContextPath() %>/userResources/images/instagram_04.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="<%=request.getContextPath() %>/userResources/images/instagram_05.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="<%=request.getContextPath() %>/userResources/images/instagram_06.jpg" alt="">
                                        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="payment-methods t-center">
                            <span><img src="<%=request.getContextPath() %>/userResources/images/paypal.jpg" alt=""></span>
                            <span><img src="<%=request.getContextPath() %>/userResources/images/visa.jpg" alt=""></span>
                            <span><img src="<%=request.getContextPath() %>/userResources/images/mastercard.jpg" alt=""></span>
                            <span><img src="<%=request.getContextPath() %>/userResources/images/discover.jpg" alt=""></span>
                            <span><img src="<%=request.getContextPath() %>/userResources/images/american.jpg" alt=""></span>
                        </div>
                    </div>
                </div>
            </div>
