...
<head>
    ...
    <link rel="icon" href="<%=request.getContextPath() %>/userResources/images/favicon.ico">
                    ...
                    <div class="row row-rl-10 row-tb-20">
                        <div class="page-content col-xs-12 col-sm-8 col-md-9">
                            ...
                            <section class="section checkout-area panel prl-30 pt-20 pb-40">
                                ...
                                <f:form class="mb-30" action="order" method="post" modelAttribute="orderVO">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>First Name</label>
                                               <f:input  type="text" path="FirstName" class="form-control" placeholder="Enter you First Name"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <f:input type="text" path="LastName" class="form-control" placeholder="Enter your last Name"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <f:input type="text" path="Contact" class="form-control" placeholder="(XXX) - XXXX - XXX" />
                                            </div>
                                        </div>
									<f:hidden path="loginVO.loginId"/>
									<f:hidden path="cartVO.cartId"/>
									
									
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Postal Code</label>
                                                <f:input type="text" path="PostalCode" class="form-control" placeholder="Enter Postal Code"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <f:input type="text" class="form-control" path="Address" placeholder="Enter your Address"/>
                                    </div>

                                
                                    <button class="btn btn-lg btn-rounded mr-10">Continue</button>
                                <a href="homepage" class="btn btn-lg btn-warning btn-rounded">Cancel Order</a>
