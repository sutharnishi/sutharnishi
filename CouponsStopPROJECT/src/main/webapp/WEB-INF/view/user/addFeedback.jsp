                    ...
                    <div class="row row-rl-10 row-tb-20">
                        <div class="page-content col-xs-12 col-sm-8 col-md-9">
                            ...
                            <section class="section checkout-area panel prl-30 pt-20 pb-40">
                                <h2 class="h2 mb-20 h-title">FeedBack Form</h2>
                                
                                <%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                                
                          
                                <f:form class="Feedbackfm" action="insertRating" method="post" modelAttribute="feedbackVO">      
                                
                                 <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>FeedBack</label>
                                              <f:textarea path="feedBack" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
