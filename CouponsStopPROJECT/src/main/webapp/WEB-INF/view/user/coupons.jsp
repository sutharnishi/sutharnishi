...
<head>
    ...
    <!-- Linearicons -->
    <link href="<%=request.getContextPath() %>/userResources/css/linearicons.css" rel="stylesheet">

    <!-- Owl Carousel -->
    <link href="<%=request.getContextPath() %>/userResources/css/owl.carousel.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath() %>/userResources/css/owl.theme.min.css" rel="stylesheet">

    <!-- Flex Slider -->
    <link href="<%=request.getContextPath() %>/userResources/css/flexslider.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="<%=request.getContextPath() %>/userResources/css/base.css" rel="stylesheet">
...
<body id="body" class="wide-layout preloader-active">
    ...
    <div id="pageWrapper" class="page-wrapper">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                <!-- <li>
                                    ...
                                    <ul>
                                        <li><a href="deal_single.html"><i class="fa fa-flag-en"></i>English</a>
                                        </li>
                                        <li><a href="./ar/deal_single.html"><i class="fa fa-flag-ar"></i>العربية</a>
                                        </li>
                                    </ul>
                                </li> -->
                                <li>
                ...
                <div class="container">
                    <div class="row row-rl-0 row-tb-20 row-md-cell">
                        <div class="brand col-md-3 t-xs-center t-md-left valign-middle">
                            <a href="#" class="logo">
                                <img src="<%=request.getContextPath() %>/userResources/images/logo1.png" alt="" width="250">
                            </a>
                        </div>
        ...
        <!-- âââââââââââââââ[ PAGE CONTENT ]âââââââââââââââ -->
        <main id="mainContent" class="main-content">
            <div class="page-container ptb-10">
                <div class="container">
                    ...
                    <c:forEach items="${coupanList}" var="i">
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath()%>/documents/coupons/${i.fileName}">
		                            ...
		                            <span class="t-uppercase" data-countdown="2019/09/01 01:30:00"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="<%=request.getContextPath()%>/userResources/images/brand_01.jpg" alt="">
                                        </div>
                                    </figure>
		                            ...
		                            <a href="dealdescription?couponId=${i.couponId}">${i.couponName }</a>
		                        </h3>
                                            ...
                                            <p class="text-muted mb-20">${i.couponDescription }</p>
                                        </div>
                                        <div class="deal-price pos-r mb-15">
                                            <h3 class="price ptb-5 text-right"><span class="price-sale">$300.00</span>RS ${i.couponPrice }</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_02.jpg">
		                            ...
		                            <span class="t-uppercase" data-countdown="2020/10/10 12:25:10"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="<%=request.getContextPath() %>/userResources/images/brand_02.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_03.jpg">
                                        <div class="label-discount left-20 top-15">-30%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
		                            ...
		                            <span class="t-uppercase" data-countdown="2020/10/10 12:25:10"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="<%=request.getContextPath() %>/userResources/images/brand_03.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
		                            ...
		                            <span class="t-uppercase" data-countdown="2018/01/02 10:35:23"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="<%=request.getContextPath() %>/userResources/images/brand_04.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_05.jpg">
		                            ...
		                            <span class="t-uppercase" data-countdown="2021/12/03 03:15:00"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="<%=request.getContextPath() %>/userResources/images/brand_05.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_06.jpg">
                                        <div class="label-discount left-20 top-15">-60%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
		                            ...
		                            <span class="t-uppercase" data-countdown="2019/10/10 12:00:00"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="<%=request.getContextPath() %>/userResources/images/brand_06.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_07.jpg">
                                        <div class="label-discount left-20 top-15">-50%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_08.jpg">
                                        <div class="label-discount left-20 top-15">-30%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_09.jpg">
                                        <div class="label-discount left-20 top-15">-30%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_10.jpg">
                                        <div class="label-discount left-20 top-15">-15%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_11.jpg">
                                        <div class="label-discount left-20 top-15">-60%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="<%=request.getContextPath() %>/userResources/images/deal_12.jpg">
                                        <div class="label-discount left-20 top-15">-60%</div>
                                        <ul class="deal-actions top-15 right-20">
                                            <li class="like-deal">
                                                <span>
 ...
 -->                        <!-- Page Pagination -->
        ...
        <!-- âââââââââââââââ[ END PAGE CONTENT ]âââââââââââââââ -->
        ...
        <!-- âââââââââââââââ[ END FOOTER ]âââââââââââââââ -->
    ...
    <!-- Modernizer JS -->
    <script src="<%=request.getContextPath() %>/userResources/js/modernizr-2.6.2.min.js"></script>
    
    <!-- Owl Carousel -->
    <script type="text/javascript" src="<%=request.getContextPath() %>/userResources/js/owl.carousel.min.js"></script>

    <!-- FlexSlider -->
    <script type="text/javascript" src="<%=request.getContextPath() %>/userResources/js/jquery.flexslider-min.js"></script>

    <!-- Coutdown -->
    <script type="text/javascript" src="<%=request.getContextPath() %>/userResources/js/jquery.countdown.js"></script>

    <!-- âââââââââââââââââââââââââââââââââââââââââ -->
    <!-- Custom Template JavaScript                   -->
    <!-- âââââââââââââââââââââââââââââââââââââââââ -->
    <script type="text/javascript" src="<%=request.getContextPath() %>/userResources/js/main.js"></script>
</body>
